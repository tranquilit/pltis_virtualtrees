...
override PACKAGE_NAME=virtualtreeview_package
override PACKAGE_VERSION=5.5.3.1
ifndef LCL_PLATFORM
...
override TARGET_UNITS+=virtualtreeview_package.pas
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_OPTIONS+=-MObjFPC -Scgim -O1 -g -gl -l -vewnhibq -dLCL -dLCL$(LCL_PLATFORM) $(DBG_OPTIONS)
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_OPTIONS+=-MObjFPC -Scgim -O1 -g -gl -l -vewnhibq -dLCL -dLCL$(LCL_PLATFORM) $(DBG_OPTIONS)
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_INCLUDEDIR+=include/intf/$(LCL_PLATFORM) units include/intf
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_INCLUDEDIR+=include/intf/$(LCL_PLATFORM) units include/intf
endif
