...
{Adapted from VirtualTrees by Luiz Américo to work in LCL/Typhon}
...
function PanningWindowProc(Window: HWnd; Msg: UInt;WPara: WParam; LPara: LParam): LResult; CDecl;
var
  PanningObject: TVirtualPanningWindow;
begin
  if Msg = WM_PAINT then
  begin
    PanningObject:=TVirtualPanningWindow(PtrInt(GetWindowLong(Window,GWL_USERDATA)));  // ct9999 CT
